<body class="bg-dark text-light">
    ...
    <div class="container-fluid mt-5">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card bg-secondary text-light w-100 min-height-500 position-relative">
                    <div class="card-header">
                        <h5 class="card-title">Du an 1</h5>
                    </div>
                    <div class="card-body">
                        <p class="card-text">
                            <!-- Đây là nội dung bạn muốn hiển thị -->
                            ...
                            its a fair trade
                            fuck u if u fake it
                            its a fucking fair trade
                        </p>
                    </div>
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            <div>
                                <small class="text-muted">Ngày cập nhật: 01/01/2023</small>
                                <br>
                                <small class="text-muted">Ngày kết thúc: 31/12/2023</small>
                            </div>
                            <div>
                                <a href="index.php?act=add_member" type="button" class="btn btn-success me-2">Thêm thành viên</a>
                                <a href="index.php?act=updata_diray" type="button" class="btn btn-warning">Sửa</a>
                            </div>
                        </div>
                        <div class="position-absolute top-0 end-0 p-2 bg-success text-light rounded-start">
                            <span class="text-white">Số thành viên: 100</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/js/bootstrap.bundle.min.js" integrity="sha384-hBtZAoT0i0j+TuKvxj/HzE62+5Jnu81L3z9ASj9smgoueJbs1DTt8jUCMlJoVmFdd" crossorigin="anonymous"></script> -->
</body>